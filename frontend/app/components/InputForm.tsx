    ...
    >
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-lg p-6 space-y-4">
        ...
        <div className="flex items-center gap-3">
          <label htmlFor="available-hours" className="text-sm text-gray-600 whitespace-nowrap">
            오늘 사용 가능한 시간:
          </label>
          <input
            id="available-hours"
            ...
            disabled={isLoading}
          />
          <span className="text-sm text-gray-600" aria-hidden="true">시간</span>
        </div>
